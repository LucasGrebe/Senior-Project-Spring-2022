...
urlpatterns = [
    ...
    path('profile/playlist/createPlaylist/',views.createPlaylist,name='create_playlist'),
    path('recent/',views.addToPlaylist,name='recent'),
    path('profile/', views.profile, name='profile'),
    path('profile/playlists/<playlistId>', views.updatePlaylists,name='playlist_edit'),
